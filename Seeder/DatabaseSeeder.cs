...
namespace efCoreSeederSample.Seeder
{
    /// <summary>
    /// Seeds database.
    /// </summary>
    /// <typeparam name="T">DbContext that models are defined in it</typeparam>
    public class DatabaseSeeder<T> : IDatabaseSeeder where T : DbContext
    {
